<?php require_once("../../controller/transaksi-penjualan.php");
        ...
        $_SESSION["project_si_penjualan_bahan_bangunan"]["name_page"] = "Ubah Input Penjualan Baru";
        ...
        <div class="nxl-content" style="height: 100vh;">
          ...
          <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
              ...
              <ul class="breadcrumb">
                <li class="breadcrumb-item">Input Penjualan Baru</li>
                <li class="breadcrumb-item"><?= $_SESSION["project_si_penjualan_bahan_bangunan"]["name_page"].' '.$view_data[""]  ?></li>
              </ul>
            </div>
          </div>
          <!-- [ page-header ] end -->
