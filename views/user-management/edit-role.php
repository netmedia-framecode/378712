...
if(!isset($_GET['p'])){
  ...
  $_SESSION["project_si_penjualan_bahan_bangunan"]["name_page"] = "Ubah Role";
  ...
  <div class="page-header">
    <div class="page-header-left d-flex align-items-center">
      ...
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><?= $_SESSION['project_si_penjualan_bahan_bangunan']['name_page'].' '.$data_user_role['role'] ?>
        </li>
      </ul>
    </div>
  </div>
