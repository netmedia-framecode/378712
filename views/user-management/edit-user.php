...
if(!isset($_GET['p'])){
  ...
  $_SESSION["project_si_penjualan_bahan_bangunan"]["name_page"] = "Ubah User";
  ...
  <div class="page-header">
    <div class="page-header-left d-flex align-items-center">
      ...
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><?= $_SESSION['project_si_penjualan_bahan_bangunan']['name_page'].' '.$data_users['name'] ?></li>
      </ul>
    </div>
  </div>
  <!-- [ page-header ] end -->
