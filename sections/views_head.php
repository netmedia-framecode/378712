...
<title><?= $data_utilities['name_web']?> <?php if (isset($_SESSION['project_si_penjualan_bahan_bangunan']['name_page'])) {
                          if (!empty($_SESSION['project_si_penjualan_bahan_bangunan']['name_page'])) {
                            echo " - " . $_SESSION['project_si_penjualan_bahan_bangunan']['name_page'];
                          }
                        } ?>
</title>
